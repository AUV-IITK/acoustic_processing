...
void powerSp(Vector2cf SteeringVector, Matrix2cf* V, int altitude, int* solution, float *minPhase){
	...
	//// IF EXTRA DEBUGGING NEEDED
	//cout<<"The value of phase is currently: " << phaseNum/phaseDen << "and minPhase is: " << *minPhase <<"\n";
	//cout <<"Current solution according to the altitude, "<< altitude<< " till now, is \n " << *solution << "\n";
...
void MUSICclassifier(Matrix2cf *V,  float *altitude, float *azimuth){
	cout << "Starting to use the MUSIC Algorithm \n";
